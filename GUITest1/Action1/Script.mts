...
Window("Calculatrice").InsightObject("InsightObject").Click @@ hightlight id_;_7_;_script infofile_;_ZIP::ssf45.xml_;_
Window("Calculatrice").InsightObject("InsightObject_2").Click @@ hightlight id_;_13_;_script infofile_;_ZIP::ssf46.xml_;_
Window("Calculatrice").InsightObject("InsightObject_3").Click
